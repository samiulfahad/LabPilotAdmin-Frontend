...
import { FileText, Trash2, ChevronRight, Eye } from "lucide-react";

const Report = ({ input, index, onDelete }) => {
  // Derive section keys (everything except _id and name)
  const sectionKeys = Object.keys(input).filter((key) => key !== "_id" && key !== "name");
